...
Познакомимся с сервисом GitHub. ***Github*** - сервис, который позволяет интегрироваться с программой ***git*** и настроить удаленную работу в нашим репозиторием, то есть мы можем хранить свой репозиторий не только на своём компьтере (локально), но и на удаленном сервисе.